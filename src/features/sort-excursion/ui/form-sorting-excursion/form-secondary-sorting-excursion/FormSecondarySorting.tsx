...
const FormSecondarySorting: React.FC<IFormSecondarySortingProps> = memo(
   (props) => {
      const { onGetQueryString, isMiddleMobile } = props
      ...
      const [typeExcursion, setTypeExcurison] = useState<string>(
         enumTypeExcursion.INDIVIDUAL
      )

      useEffect(() => {
         const query = GenerateQuerySort(
            undefined,
            date,
            primaryMoney,
            secondaryMoney,
         ...
         <div className={style.form_secondary}>
            <div className={style.slice}>
               ...
               <Field
                  ...
                  width={isMiddleMobile ? '75px' : '91px'}
                  height={isMiddleMobile ? '35px' : '45px'}
            ...
            <div className={style.slice}>
               ...
               <Field
                  ...
                  width={isMiddleMobile ? '91px' : '112px'}
                  height={isMiddleMobile ? '35px' : '45px'}
                  className={style.field_wrap}
                  classNameInput={style.field}
               />
            ...
            <div className={style.slice}>
               ...
               <Field
                  ...
                  selection={[markingTypePay[0].name, markingTypePay[1].name]}
                  height={isMiddleMobile ? '35px' : '45px'}
                  width={isMiddleMobile ? '245px' : '352px'}
                  classNameInput={style.field}
                  className={style.field_wrap}
            ...
            <div className={style.slice}>
               ...
               <Field
                  ...
                  height={isMiddleMobile ? '35px' : '45px'}
                  width={isMiddleMobile ? '156px' : '204px'}
                  className={style.field_wrap}
                  classNameInput={style.field}
