      ...
      <footer className={style.footer}>
         <div className={style.links}>
            ...
            <GroupLinks className={style.group_links} title="Сервис">
               <Link margin="0 0 5px 0" to={pathRoutes.about.path}>
                  {pathRoutes.about.name}
               </Link>
               <Link margin="0 0 5px 0" to={pathRoutes.articles.path}>
                  {pathRoutes.articles.name}
               </Link>
               <Link margin="0 0 5px 0" to="/">
                  FAQ
               </Link>
               <Link to="/">Сопособы оплаты</Link>
            </GroupLinks>
            <GroupLinks className={style.group_links} title="Гидам">
               <Link margin="0 0 5px 0" to={pathRoutes.guide.path}>
                  Стать гидом
               </Link>
               <Link margin="0 0 5px 0" to="/">
                  Правила работы
