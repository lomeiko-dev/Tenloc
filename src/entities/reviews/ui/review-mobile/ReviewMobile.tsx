...
interface IReviewMobileProps
   extends Omit<IReview, 'id' | 'userId' | 'cityName' | 'excursionId'> {
   className?: string
}

const ReviewMobile: React.FC<IReviewMobileProps> = memo((props) => {
   const { avatar, message, nickname, score, className } = props
   ...
   return (
      <div className={classNames(style.wrapper_mobile, className)}>
         ...
         <div className={style.info_mobile}>
            <Text fontSize={17} fontWeight={500} text={nickname} />
