...
export const FooterMobile: React.FC<IFooterMobileProps> = memo(({ isMediumWidth }) => {
  ...
  return (
        <div className={style.footer_mobile}>
            ...
            <GroupLinks margin="20px 0 0 0" title="Поддержка клиентов" className={style.group_links}>
                <span>
                    <Text
                        fontSize={isMediumWidth ? 9 : 14} fontWeight={isMediumWidth ? 400 : 600}
                        text="Телефон: "/>
                    <Text
                        fontSize={isMediumWidth ? 9 : 14} fontWeight={isMediumWidth ? 300 : 400}
                        text={feedbackJson.phone}/>
                </span>
                <span>
                    <Text
                        fontSize={isMediumWidth ? 9 : 14} fontWeight={isMediumWidth ? 400 : 600}
                ...
                <span>
                    ...
                    <Text
                        fontSize={isMediumWidth ? 9 : 14} fontWeight={isMediumWidth ? 300 : 400}
                        text={`${locationJson.city}, ${locationJson.street}, ${locationJson.other_info}`}/>
                </span>
                <ButtonSocial
                    margin="25px 0 0 0"
                    isMobile
                    linkInstagram={linksJson.instagram} linkWatsapp={linksJson.watsapp}
                    linkTelegram={linksJson.telegram} linkVk={linksJson.vk} />
            </GroupLinks>
