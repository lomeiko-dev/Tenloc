...
import { type IGetPageArticleData, type IGetPageArticleProps } from './payload-types'
...
export const { useGetPageArticlesQuery, useLazyGetPageArticlesQuery } = articleApi
